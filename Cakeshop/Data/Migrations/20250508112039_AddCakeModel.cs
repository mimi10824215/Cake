...
{
    /// <inheritdoc />
    public partial class AddCakeModel : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShoppingAddess = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrdersDetials", x => x.Id);
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_OrdersDetials_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrdersDetials_CakeId",
                table: "OrdersDetials",
                column: "CakeId");

            migrationBuilder.CreateIndex(
                name: "IX_OrdersDetials_OrderId",
                table: "OrdersDetials",
                column: "OrderId");
